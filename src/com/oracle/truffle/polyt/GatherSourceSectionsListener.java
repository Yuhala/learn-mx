 ...
 *
 * Because we
 * {@link PolyTaint#enable(com.oracle.truffle.api.instrumentation.TruffleInstrument.Env)
...
final class GatherSourceSectionsListener implements LoadSourceSectionListener {
    ...
    private final PolyTaint instrument;

    GatherSourceSectionsListener(PolyTaint instrument) {
     ...
     *              {@link PolyTaint#coverageMap} up to date.
     */
    @Override
